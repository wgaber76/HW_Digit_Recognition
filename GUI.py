...
def MyProject():
	...
	'''x = cv.winfo_rootx() + Loc_x
	y = cv.winfo_rooty() + Loc_y
	x1 = x + Window_Width
	y1 = y + Window_Height'''
	...
	#img = ImageGrab.grab().resize((28, 28))
...
cv = Canvas(window, width=Window_Width, height=Window_Height, bg='black')
cv.place(x=Loc_x, y=Loc_y)
